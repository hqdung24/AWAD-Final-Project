...
// Mock data - commented out, replaced with real API
/* const mockTrips = [
  {
    id: 1,
  ...
  },
  {
    ...
    busType: 'Limousine',
    company: 'Thanh Buoi',
    amenities: ['wifi', 'ac', 'water', 'blanket', 'snack'],
    seatsAvailable: 5,
  },
  {
    id: 5,
...
export default function SearchResults() {
  ...
  const passengers = searchParams.get('passengers') || '1'; // number of seats user wants to book, default to 1, BE will base on available seats
  ...
  // Temporary: No filtering, sorting, or pagination yet - just display raw results
  // TODO: Implement filters, sorting, and pagination with API integration
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">
            {date} • {passengers} passenger{parseInt(passengers) > 1 ? 's' : ''}{' '}
            • {tripsData?.total || 0} trip
            {(tripsData?.total || 0) !== 1 ? 's' : ''} found
          </p>
        </div>
                    ...
                    {departureTimeSlots.map((slot) => (
                      ...
                      >
                        <Checkbox
                          ...
                          onCheckedChange={() =>
                            handleTimeSlotToggle(slot.value)
                          }
                        />
                        <Label
                          htmlFor={slot.value}
              ...
              <CardContent className="p-4">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  ...
                  <div className="text-sm text-muted-foreground">
                    Showing {paginatedTrips.length} of {sortedTrips.length}{' '}
                    result{sortedTrips.length !== 1 ? 's' : ''}
                  </div>
                </div>
              </CardContent>
            </Card>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                      ...
                      <div className="md:col-span-2 flex flex-col justify-center">
                        ...
                        <p className="text-xs text-muted-foreground">
                          standard
                          {/* standard {temporarily not implemented bus type} */}
                        </p>
                      </div>
                      ...
                      <div className="md:col-span-2 flex items-center justify-center gap-2">
                        {trip.bus.amenitiesJson.includes('wifi') && (
                          <Wifi className="h-4 w-4 text-info" />
                        )}
                        {trip.bus.amenitiesJson.includes('ac') && (
                          <Snowflake className="h-4 w-4 text-info" />
                        )}
                        {trip.bus.amenitiesJson.includes('water') && (
                          <Coffee className="h-4 w-4 text-info" />
                        )}
                        {trip.bus.amenitiesJson.includes('blanket') && (
                      ...
                      <div className="md:col-span-3 flex flex-col justify-center items-end gap-2">
                        <div className="text-right">
                          ...
                          <p className="text-xs text-muted-foreground">
                            {trip.bus.seatCapacity} seats left
                          </p>
                        </div>
