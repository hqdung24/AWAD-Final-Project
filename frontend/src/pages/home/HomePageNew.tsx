...
export default function HomePageNew() {
    ...
    const recentChats = [
        { id: 1, name: 'Design Team', lastMessage: 'Great work on the mockups!', time: '2m ago', unread: 3 },
        { id: 2, name: 'Project Alpha', lastMessage: 'Meeting scheduled for tomorrow', time: '15m ago', unread: 0 },
        { id: 3, name: 'Sarah Johnson', lastMessage: 'Thanks for the update', time: '1h ago', unread: 1 },
        { id: 4, name: 'Marketing Group', lastMessage: 'Campaign launched successfully', time: '3h ago', unread: 0 },
    ];
                            ...
                            <Button variant="outline" className="w-full justify-start h-auto p-4">
                                <div className="flex items-center gap-3 w-full">
                                    ...
                                    <div className="text-left flex-1">
                                        ...
                                        <div className="text-xs text-muted-foreground">Start a group conversation</div>
                                    </div>
                                </div>
                            </Button>
                            <Button variant="outline" className="w-full justify-start h-auto p-4">
                                <div className="flex items-center gap-3 w-full">
                                    ...
                                    <div className="text-left flex-1">
                                        ...
                                        <div className="text-xs text-muted-foreground">Connect with someone new</div>
                                    </div>
                                </div>
                            </Button>
                            <Button variant="outline" className="w-full justify-start h-auto p-4">
                                <div className="flex items-center gap-3 w-full">
                                    ...
                                    <div className="text-left flex-1">
                                        ...
                                        <div className="text-xs text-muted-foreground">Upload and share documents</div>
                                    </div>
                                </div>
                            </Button>
                        </Stack>
